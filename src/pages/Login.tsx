  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to Christ Acade Group of School!",
        variant: "default",
      });
    }, 1500);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-serif font-bold text-school-primary">
            Welcome Back
          </h2>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="text-school-primary hover:underline">
                    Forgot password?
                  </Link>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-school-primary focus:ring-school-primary"
                />
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/apply" className="font-medium text-school-primary hover:underline">
              Apply for admission
            </Link>
          </p>
        </div>
